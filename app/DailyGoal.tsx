        ...
        <View className="bg-[#565967] px-5 py-4 rounded-lg mt-4">
          <View className="">
            ...
            <Text className="text-[#afafc1] font-light text-xs mt-3">
              <Text className="font-bold">How to calculate:</Text> Water intake
              (in ounces) = Body weight (in pounds) × 0.5
            </Text>
            ...
            <Text className="text-[#afafc1] font-light text-xs mt-4">
              <Text className="font-bold">Exercise:</Text> Add 12–16 ounces for
